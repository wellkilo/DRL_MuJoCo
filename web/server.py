...
TARGET_DURATION = 15.0  # 目标视频时长 15 秒
...
print(f"[Video Script] Generating distributed video ({TARGET_DURATION}s)...", flush=True)
...
print(f"[Video Script] Generating single video ({TARGET_DURATION}s)...", flush=True)
